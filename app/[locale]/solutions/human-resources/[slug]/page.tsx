...
export default async function HRSolutionPage({
  params,
}: {
  params: Promise<{ locale: string; slug: string }>;
}) {
  ...
  if (!solution || solution.category !== 'human-resources') {
    notFound();
  }
  ...
  return (
    <SolutionPageTemplate
      locale={locale}
      categoryName={tNav('hr.title')}
      categoryHref="/solutions/human-resources"
